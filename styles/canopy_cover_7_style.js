var size = 0;
var placement = 'point';
function categories_canopy_cover_7(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Up to 10% (or outside Bendigo)':
...
var style_canopy_cover_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_canopy_cover_7(feature, value, size, resolution, labelText,
