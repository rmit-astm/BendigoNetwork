...
lyr_lanenumbersoneway_7.set('fieldLabels', {'ogc_fid': 'hidden field', 'lanes': 'inline label - visible with data', });
lyr_speedlimit_8.set('fieldLabels', {'ogc_fid': 'hidden field', 'speed_limit': 'inline label - visible with data', });
lyr_cyclewaystatus_9.set('fieldLabels', {'ogc_fid': 'hidden field', 'cycleway': 'inline label - always visible', });
lyr_highwaytype_10.set('fieldLabels', {'ogc_fid': 'hidden field', 'highway_type': 'inline label - always visible', });
