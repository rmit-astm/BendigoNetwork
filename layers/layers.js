...
var format_cyclingmixedtraffic_10 = new ol.format.GeoJSON();
var features_cyclingmixedtraffic_10 = format_cyclingmixedtraffic_10.readFeatures(json_cyclingmixedtraffic_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cyclingmixedtraffic_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cyclingmixedtraffic_10.addFeatures(features_cyclingmixedtraffic_10);
var lyr_cyclingmixedtraffic_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cyclingmixedtraffic_10, 
                style: style_cyclingmixedtraffic_10,
                popuplayertitle: "cycling: mixed traffic",
                interactive: true,
                title: '<img src="styles/legend/cyclingmixedtraffic_10.png" /> cycling: mixed traffic'
            });
var format_cyclingonroadlane_11 = new ol.format.GeoJSON();
var features_cyclingonroadlane_11 = format_cyclingonroadlane_11.readFeatures(json_cyclingonroadlane_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cyclingonroadlane_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cyclingonroadlane_11.addFeatures(features_cyclingonroadlane_11);
var lyr_cyclingonroadlane_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cyclingonroadlane_11, 
                style: style_cyclingonroadlane_11,
                popuplayertitle: "cycling: onroad lane",
                interactive: true,
                title: '<img src="styles/legend/cyclingonroadlane_11.png" /> cycling: onroad lane'
            });
var format_cyclingseparatedlane_12 = new ol.format.GeoJSON();
var features_cyclingseparatedlane_12 = format_cyclingseparatedlane_12.readFeatures(json_cyclingseparatedlane_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cyclingseparatedlane_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cyclingseparatedlane_12.addFeatures(features_cyclingseparatedlane_12);
var lyr_cyclingseparatedlane_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cyclingseparatedlane_12, 
                style: style_cyclingseparatedlane_12,
                popuplayertitle: "cycling: separated lane",
                interactive: true,
                title: '<img src="styles/legend/cyclingseparatedlane_12.png" /> cycling: separated lane'
            });
var format_cyclingoffroadpath_13 = new ol.format.GeoJSON();
var features_cyclingoffroadpath_13 = format_cyclingoffroadpath_13.readFeatures(json_cyclingoffroadpath_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cyclingoffroadpath_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cyclingoffroadpath_13.addFeatures(features_cyclingoffroadpath_13);
var lyr_cyclingoffroadpath_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cyclingoffroadpath_13, 
                style: style_cyclingoffroadpath_13,
                popuplayertitle: "cycling: offroad path",
                interactive: true,
                title: '<img src="styles/legend/cyclingoffroadpath_13.png" /> cycling: offroad path'
            });
var format_highwaytype_14 = new ol.format.GeoJSON();
var features_highwaytype_14 = format_highwaytype_14.readFeatures(json_highwaytype_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_highwaytype_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_highwaytype_14.addFeatures(features_highwaytype_14);
var lyr_highwaytype_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_highwaytype_14, 
                style: style_highwaytype_14,
                popuplayertitle: "highway type",
                interactive: true,
    title: 'highway type<br />\
    <img src="styles/legend/highwaytype_14_0.png" /> motorway<br />\
    <img src="styles/legend/highwaytype_14_1.png" /> arterial<br />\
    <img src="styles/legend/highwaytype_14_2.png" /> collector<br />\
    <img src="styles/legend/highwaytype_14_3.png" /> local<br />\
    <img src="styles/legend/highwaytype_14_4.png" /> offroad<br />'
        });
var format_intersectiontype_15 = new ol.format.GeoJSON();
var features_intersectiontype_15 = format_intersectiontype_15.readFeatures(json_intersectiontype_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_intersectiontype_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_intersectiontype_15.addFeatures(features_intersectiontype_15);
var lyr_intersectiontype_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_intersectiontype_15, 
                style: style_intersectiontype_15,
                popuplayertitle: "intersection type",
                interactive: true,
    title: 'intersection type<br />\
    <img src="styles/legend/intersectiontype_15_0.png" /> signalised<br />\
    <img src="styles/legend/intersectiontype_15_1.png" /> roundabout<br />\
    <img src="styles/legend/intersectiontype_15_2.png" /> simple<br />'
        });
var group_networknodes = new ol.layer.Group({
                                layers: [lyr_intersectiontype_15,],
                                fold: "open",
                                title: "network nodes"});
var group_networklinks = new ol.layer.Group({
                                layers: [lyr_publictransport_4,lyr_leveloftrafficstress_5,lyr_canopy_cover_6,lyr_slope_7,lyr_lanenumbersoneway_8,lyr_speedlimit_9,lyr_cyclingmixedtraffic_10,lyr_cyclingonroadlane_11,lyr_cyclingseparatedlane_12,lyr_cyclingoffroadpath_13,lyr_highwaytype_14,],
                                fold: "open",
                                title: "network links"});
...
lyr_OpenStreetMap_0.setVisible(true);lyr_destinationtypepoints_1.setVisible(false);lyr_destinationtypelinesbendigo_parking_2.setVisible(false);lyr_destinationtypepolygons_3.setVisible(false);lyr_publictransport_4.setVisible(false);lyr_leveloftrafficstress_5.setVisible(false);lyr_canopy_cover_6.setVisible(false);lyr_slope_7.setVisible(false);lyr_lanenumbersoneway_8.setVisible(false);lyr_speedlimit_9.setVisible(false);lyr_cyclingmixedtraffic_10.setVisible(true);lyr_cyclingonroadlane_11.setVisible(true);lyr_cyclingseparatedlane_12.setVisible(true);lyr_cyclingoffroadpath_13.setVisible(true);lyr_highwaytype_14.setVisible(false);lyr_intersectiontype_15.setVisible(false);
...
lyr_cyclingmixedtraffic_10.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'cycleway': 'cycleway', });
lyr_cyclingonroadlane_11.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'cycleway': 'cycleway', });
lyr_cyclingseparatedlane_12.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'cycleway': 'cycleway', });
lyr_cyclingoffroadpath_13.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'cycleway': 'cycleway', });
lyr_highwaytype_14.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'highway_type': 'highway_type', });
lyr_intersectiontype_15.set('fieldAliases', {'ogc_fid': 'ogc_fid', 'type': 'type', });
...
lyr_cyclingmixedtraffic_10.set('fieldImages', {'ogc_fid': '', 'cycleway': '', });
lyr_cyclingonroadlane_11.set('fieldImages', {'ogc_fid': '', 'cycleway': '', });
lyr_cyclingseparatedlane_12.set('fieldImages', {'ogc_fid': '', 'cycleway': '', });
lyr_cyclingoffroadpath_13.set('fieldImages', {'ogc_fid': '', 'cycleway': '', });
lyr_highwaytype_14.set('fieldImages', {'ogc_fid': 'TextEdit', 'highway_type': 'TextEdit', });
lyr_intersectiontype_15.set('fieldImages', {'ogc_fid': 'TextEdit', 'type': 'TextEdit', });
...
lyr_cyclingmixedtraffic_10.set('fieldLabels', {'ogc_fid': 'hidden field', 'cycleway': 'inline label - visible with data', });
lyr_cyclingonroadlane_11.set('fieldLabels', {'ogc_fid': 'hidden field', 'cycleway': 'inline label - visible with data', });
lyr_cyclingseparatedlane_12.set('fieldLabels', {'ogc_fid': 'hidden field', 'cycleway': 'inline label - visible with data', });
lyr_cyclingoffroadpath_13.set('fieldLabels', {'ogc_fid': 'hidden field', 'cycleway': 'inline label - visible with data', });
lyr_highwaytype_14.set('fieldLabels', {'ogc_fid': 'hidden field', 'highway_type': 'inline label - always visible', });
lyr_intersectiontype_15.set('fieldLabels', {'ogc_fid': 'hidden field', 'type': 'inline label - visible with data', });
lyr_intersectiontype_15.on('precompose', function(evt) {
